...
0.19);">
    ...
    <div class="col-md-4">
    <a href="TambahMoviePage.php?id=.$data['id'].'"onClick="return confirm ( \'Yakin ingin meanmbah Movie?\')"><i style="color: blue" class="fa-sharp fa-solid fa-square-plus fa-3x"></i></a>
    </div>
